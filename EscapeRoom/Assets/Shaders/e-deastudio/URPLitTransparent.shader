...
Shader "e-deastudio/URPLitTransparent"
{
	Properties
	{
		...
		[ASEEnd]_OpacityMap("Opacity Map", 2D) = "gray" {}
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 break13 = tex2D( _Albedo, uv_Albedo );
				float4 appendResult14 = (float4(break13.r , break13.g , break13.b , 0.0));
				
				float2 uv_OpacityMap = IN.ase_texcoord8.xy * _OpacityMap_ST.xy + _OpacityMap_ST.zw;
				float grayscale15 = Luminance(tex2D( _OpacityMap, uv_OpacityMap ).rgb);
				
				float3 Albedo = appendResult14.rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_OpacityMap = IN.ase_texcoord4.xy * _OpacityMap_ST.xy + _OpacityMap_ST.zw;
				float grayscale15 = Luminance(tex2D( _OpacityMap, uv_OpacityMap ).rgb);
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_OpacityMap = IN.ase_texcoord.xy * _OpacityMap_ST.xy + _OpacityMap_ST.zw;
				float grayscale15 = Luminance(tex2D( _OpacityMap, uv_OpacityMap ).rgb);
				
				surfaceDescription.Alpha = grayscale15;
...
/*ASEBEGIN
Version=18935
192;75;705;452;578.2977;436.6327;1.345439;True;False
Node;AmplifyShaderEditor.SamplerNode;11;-541.9706,-116.4182;Inherit;True;Property;_OpacityMap;Opacity Map;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-506.9892,-343.7973;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.BreakToComponentsNode;13;-198.8839,-330.343;Inherit;True;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.DynamicAppendNode;14;-56.2673,-368.0151;Inherit;False;COLOR;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TFHCGrayscale;15;-181.3931,-86.8185;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=2706400945C3C69AE83BC797B6D2252FAB57C14E